...
module meme_launchpad::meme_token {
    ...
    const ICON_URL: vector<u8> = b"http://localhost:3001/uploads/2025-06-16T14-10-18.087Z-Screenshot 2025-06-16 190507.png";
    const DECIMALS: u8 = 9;
    const NAME: vector<u8> = b"demo";
    const SYMBOL: vector<u8> = b"😍";
    const DESCRIPTION: vector<u8> = b"demodemo";
