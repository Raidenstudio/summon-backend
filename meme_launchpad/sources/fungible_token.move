...
module meme_launchpad::meme_token {
    ...
    const ICON_URL: vector<u8> = b"https://raidenimage.blob.core.windows.net/raidenimg/2025-08-15T07-31-19.626Z-logo%20color%20(horizontally)%201%203%201.png";
    const DECIMALS: u8 = 9;
    const NAME: vector<u8> = b"Nowsath A";
    const SYMBOL: vector<u8> = b"now";
    const DESCRIPTION: vector<u8> = b"ffffffff";
